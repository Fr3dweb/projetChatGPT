(function (e, t) {
    ...
    return function () {
        ...
        function Tt() {
            ...
            if (z.config.historyEnabled) history.replaceState({htmx: true}, $().title, window.location.href)
        }
        ...
        function Nt(a) {
            ...
            e.onload = function () {
                if (this.status >= 200 && this.status < 400) {
                    ...
                    At(r.tasks);
                    Et = a;
                    ee($().body, "htmx:historyRestore", {path: a, cacheMiss: true, serverResponse: this.response})
                } else {
        ...
        function or(e, t, r) {
            ...
            if (r) {
                if (r instanceof Element || g(r, "String")) {
                    return lr(e, t, null, null, {targetOverride: M(r), returnPromise: true})
                } else {
            ...
            Y(["loadstart", "loadend", "progress", "abort"], function (t) {
                Y([o, o.upload], function (e) {
                    e.addEventListener(t, function (e) {
                        ee(n, "htmx:xhr:" + t, {lengthComputable: e.lengthComputable, loaded: e.loaded, total: e.total})
                    })
                })
            });
        ...
        function fr(s, l) {
            ...
            if (t) {
                Q(s, "htmx:responseError", ne({error: "Response Status Error Code " + u.status + " from " + l.pathInfo.requestPath}, l))
            }
        }
        ...
        function mr() {
            if (z.config.includeIndicatorStyles !== false) {
                $().head.insertAdjacentHTML("beforeend", "<style>                      ." + z.config.indicatorClass + "{opacity:0;transition: opacity 200ms ease-in;}                      ." + z.config.requestClass + " ." + z.config.indicatorClass + "{opacity:1}                      ." + z.config.requestClass + "." + z.config.indicatorClass + "{opacity:1}                    </style>")
            }
        }
